  ...
  return (
    <div className="" style={{ width: '100%', overflowX: 'hidden' }}>
      <ul>
        ...
        >
          &nbsp;Résultats Bande Large (BL) en «dBµA/m»
        </li>
      </ul>
      ...
      <Table style={{ width: '100%', border: 'none' }}>
        ...
        <TableFooter>
          <TableRow>
            ...
            <TableCell
              colspan={13}
              style={{ padding: '0px 16px', border: 'none' }}
            >
              {' '}
              Valeur inférieure ou égale à la limite associée au détecteur
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell
            ...
            >
              {' '}
              Valeur supérieure à la limite associée au détecteur
            </TableCell>
          </TableRow>
          <TableRow>
            <TableCell
            ...
            >
              {' '}
              Bruit ambiant mesuré supérieur aux limites de la norme -6 dB ==>
              DGII IP3M AME ne peut pas tenir compte de cette valeur
            </TableCell>
          </TableRow>
        </TableFooter>
      </Table>
      <ul>
        ...
        >
          &nbsp;Résultats Bande étroite (BE) en « dBµA/m»
        </li>
      </ul>
      ...
      >
          ...
          <TableRow>
            <TableCell
              style={{
                ...
                transform: 'translateZ(0)',
                /*background:
                  'linear-gradient(0deg, rgba(0,0,0,0.1), rgba(0,0,0,0.2))',*/
                fontWeight: 'bold',
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell
              style={{ padding: '0px 16px', border: '1px solid black' ,textAlign:'center'}}
              className="axe rail"
            >
              X
            </TableCell>
          ...
          <TableRow>
            ...
            <TableCell
              colspan={12}
              style={{ minWidth: '100px', whiteSpace: 'nowrap',textAlign:'center'}}
              className="ble ligne"
            >
