      ...
      if (inputValues) {
        const filteredTrains = trains.filter((train) => {
          ...
          if (
            ...
            !(train.datesam + '-' + train.heuresam).includes(
              inputValues.searchDate
            )
          ) {
          ...
          if (
            ...
            ((train.statutSAM !== inputValues.searchSam.toUpperCase() &&
              inputValues.searchSam !== 'uniquement sam') ||
              !train.statutSAM)
          ) {
            console.log(
              'filtrageSam',
              train.statutSAM,
              inputValues.searchSam.toUpperCase()
            )
            return false
          }
          if (
            ...
            ((train.statut50592 !== inputValues.search50592.toUpperCase() &&
              inputValues.search50592 !== 'uniquement 50592') ||
              !train.statut50592)
          ) {
            return false
          }
              ...
              /> */}
                  ...
                  <TableCell style={{ verticalAlign: 'top' }} align="center">
                    <div style={{ fontWeight: 'bold' }}>
                      <img
                        src={temp}
                        alt="Température / Humidité / courant dans le rail"
                        style={{
                          height: '65px',
                          width: '100px',
                          marginTop: '-2px',
                            ...
                            >
                              ...
                              <div className="l" style={{ width: '100%',maxWidth:'2100px'}}>
                                <TableResultat
                                  ...
                                  ber1={train.ber1}
                                  ber2={train.ber2}
                                  parBE={train.entetesbe}
                                  parBL={train.entetesbl}
                                  parOB={train.entetehorsbande}
                                  ob={train.outofband}
                                  fob={train.fondhorsbande}
                                  freqBL={train.frequencebl}
                                />
                              </div>
                            </td>
                          </TableRow>
              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    >
                      Aucun dépassement des limites au sens de la NF EN 50592 ;
                      ou aucune occultation selon la SAM S005
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      Dépassement d'au moins une limite au sens de la norme NF
                      EN 50592 ; ou occultation selon la SAM S005
                    </td>
                  </tr>
                  <tr>
                    <td
                    ...
                    >
                      Le système d'acquisition NF EN 50592 et/ou SAM S005 est
                      Hors Service (passage non enregistré)
                    </td>
                  </tr>
                </tbody>
              </table>
