    ...
    return(
        <div className="parent home" style={{ display: 'block' }}>
          ...
          <div className="slider">
            ...
            <span style={{ '--i': 1 }}><Link to="/journal"><img src={image1}alt="image1"></img></Link></span>
            
           <span style={{ '--i': 2 }}><Link to="/historique"> <img src={image2}alt="image2"></img></Link></span> 
            <span style={{ '--i': 3 }}><Link to="/synoptique"><img src={image3}alt="image3"></img></Link></span> 
           <span style={{ '--i': 4 }}><Link to="/jourJ"> <img src={image4}alt="image4"></img></Link></span> 
