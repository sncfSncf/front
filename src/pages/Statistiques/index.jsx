    ...
    if (resultSAM === 'NOK'|| resultSAM === 'uniquement sam') {
      ...
      for (let i = 0; i < infos.length; i++) {
        if (infos[i]['pourcentage de perturbation par index d\'un type mr']) {
          ...
          evs = Object.keys(infos[i]['pourcentage de perturbation par index d\'un type mr'])
          ...
          if (resultSAM !== 'uniquement sam' && result50592) {
            ...
            if (result50592 === 'OK') {
              if (infos[i]['le poucentage de chaque type mr (50592 ok)']) {
                ...
                data50592.datasets[0].data.push(
                  pourcentage50592
                )
                new Chart(ctx50592, {
                  type: 'bar',
      ...
      <div className="parent historique">
        ...
        <div className="statistique" style={{ position: 'relative' }}>
          <p>
            ...
            >
             <PDFStatistique periode={[startDate, endDate]} site={site} />
          ...
          <div>
            ...
            <div className="filtreS">
              ...
              <ul>
                <li>Période: {startDate}-{endDate}</li>
                <li>Site: {site}</li>
              </ul>)}
          ...
          <div className='tableau-stat'>
          {(resultSAM !=='' && pourcentageSAM !==null)&&(
            <Table
            style={{ width: 'auto',maxWidth:'40%',position: 'relative', margin: '20px auto' }}
          >
            {resultSAM === 'OK' ? (
               <>
               <TableHead>
          ...
          {(result50592 !==''&& pourcentage50592!==null)&&(
            <Table
            style={{ width: '50%', position: 'relative', margin: '20px auto' }}
          >
            {result50592 === 'OK' ? (
               <>
               <TableHead>
